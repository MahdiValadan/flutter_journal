...
import 'package:flutter_journal/models/journal_preview.dart';
      ...
      body: Center(
        child: Container(
          ...
          child: ListView.builder(
            itemCount: journalPreviews.length,
            itemBuilder: (BuildContext context, int index) {
              final item = journalPreviews[index];
              return Container(
                height: 136,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [Icons.bookmark_border_rounded, Icons.share, Icons.more_vert]
                                .map((e) {
                              return InkWell(
                                onTap: () {},
                                child: Padding(
...
final List<JournalPreview> journalPreviews = [
  JournalPreview(
